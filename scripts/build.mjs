...
const assets = ["index.html", "styles.css", "app.js", "tracker-core.js", "trajectory.js", "tracker.worker.js", "manifest.webmanifest", "sw.js", "favicon.svg", "icon.svg"];
...
for (const asset of ["styles.css", "app.js", "tracker-core.js", "trajectory.js", "manifest.webmanifest", "icon.svg"]) if (!html.includes(`/${asset}`)) throw new Error(`index.html does not reference /${asset}`);
